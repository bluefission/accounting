...
@section('content')
    ...
    <link href="vendor/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Supply</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                                <a href="#" id="new-supply-btn" class="btn btn-lg btn-success btn-block">Add New</a>
                        </div>
                        <!-- /.panel-heading -->
...
@section('scripts')
    ...
    <script src="vendor/datatables-responsive/dataTables.responsive.js"></script>
    <script src="js/controllers/supply-manage-controller.js"></script>
    <script src="js/viewmodels/supply-viewmodel.js"></script>
    <script>
    $(document).ready( function() {
      ...
      var controller = new SupplyManageController();
